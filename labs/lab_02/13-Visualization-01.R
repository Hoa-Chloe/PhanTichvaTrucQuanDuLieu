...
barplot(scores,
        names.arg = subjects,
        main = "Điểm thi của bạn (Bar ngang)",
        xlab = "Điểm",
        col = c("red","blue","green","orange","purple"),
        horiz = TRUE)
# ------------------------------------------------------------------------------
...
boxplot(Petal.Length ~ Species,
        data = iris,
        main = "So sánh Petal Length giữa các loài",
        xlab = "Loài",
        ylab = "Petal Length",
        col = c("red","lightpink","lightblue"))
# ------------------------------------------------------------------------------
...
lines(1:4, sales_matrix[,2], col="blue", lwd=2)
lines(1:4, sales_matrix[,3], col="green", lwd=2)
lines(1:4, sales_matrix[,4], col="orange", lwd=2)
...
plot(1:4, sales_matrix[,1],
     ...
     ylim=c(100,220),
     main="Doanh thu sản phẩm")
lines(1:4, sales_matrix[,2], col="blue", lwd=2)
lines(1:4, sales_matrix[,3], col="green", lwd=2)
lines(1:4, sales_matrix[,4], col="orange", lwd=2)

# Pie chart tổng doanh thu quý
pie(total_quarter,
    labels=c("Q1","Q2","Q3","Q4"),
    col=rainbow(4),
    main="Tỷ lệ doanh thu theo quý")

# Bar chart tổng doanh thu sản phẩm
