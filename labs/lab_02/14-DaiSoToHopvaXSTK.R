...
choose(2, 1) * choose(6, 4) * choose(5, 4) * choose(2, 2)
# ------------------------------------------------------------------------------
# Bài tập 4: Xác suất
# ------------------------------------------------------------------------------
...
total_3 <- choose(52, 3)
#    - Cả 3 lá đều là át
p_3_ats <- choose(4, 3) / total_3
#    - Có đúng 2 lá át
p_2_ats <- (choose(4, 2) * choose(48, 1)) / total_3
#    - Có ít nhất 1 lá át
p_at_least_1 <- 1 - (choose(48, 3) / total_3)

# 2. Một hộp có 10 viên bi, trong đó 6 viên đỏ và 4 viên xanh. 
#    Lấy ngẫu nhiên 3 viên. Tính xác suất:
total_ball <- choose(10, 3)
#    - Cả 3 viên đều đỏ
choose(6, 3) / total_ball
#    - Có đúng 2 viên đỏ
p_2_red <- (choose(6, 2) * choose(4, 1)) / total_ball
#    - Có ít nhất 1 viên đỏ
p_at_least_1_red <- 1 - (choose(4, 3) / total_ball)

# 3. Một lớp có 25 sinh viên, trong đó 10 nữ. 
#    Chọn ngẫu nhiên 4 sinh viên. Tính xác suất:
total_sv <- choose(25, 4)
#    - Cả 4 đều là nữ
p_4_female <- choose(10, 4) / total_sv
#    - Có đúng 2 nữ
p_2_female <- (choose(10, 2) * choose(15, 2)) / total_sv
#    - Có ít nhất 1 nữ
p_min_1_female <- 1 - (choose(15, 4) / total_sv)
